...
`In the initial phase the JS runs and checks for all the declared variables in the code and creates the space in the memory with undefined data type and undefined value.
This is the memory creation phase.

As the second phase runs the code then inserts the value for the declared variable and sets up the data type too. This phase is called as code execution phase.`

`The memory creation phase and code execution space cannot be directly viewed, but still the phases of the code execution can be viewed under inspect -> sources tab where in 
